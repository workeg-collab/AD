...
========================================
- 🎨 الشعار / اللوجو: ${logoInfo || 'لم يتم إرفاقه (سيتم الإرسال بالواتساب)'}
- 📸 صور النشاط والمنتجات: ${photosInfo || 'لم يتم إرفاقها (سيتم الإرسال بالواتساب)'}
- 📄 بروفايل الشركة / النشاط: ${profileInfo || 'لم يتم إرفاقه (سيتم الإرسال بالواتساب)'}

📝 محتوى ونصوص الموقع المطلوب كتابتها:
${aboutContent || 'سيتم استلام المحتوى والتفاصيل عبر الواتساب'}

📍 بيانات التواصل والعنوان:
${contactInfo || 'حسب بيانات الطلب أعلاه'}
    ...
    try {
      await fetch(`https://formsubmit.co/ajax/${targetEmail}`, {
        ...
        body: JSON.stringify({
          ...
          'محتوى ونصوص الموقع': aboutContent || 'بالواتساب',
          'العنوان وبيانات التواصل': contactInfo || 'بالواتساب',
          'ملاحظات إضافية': notes || 'لا يوجد',
